...
void main() {
    ...
    const float range = 0.2; // Length of glow streaks // 0.1
    const float steps = 0.005; // Number of texture samples divided by 2   // 0.005
    const float threshold = 0.3; // Color key threshold (0-1) // 0.6 
    const float brightness = 3.0; // Glow brightness 5.0
